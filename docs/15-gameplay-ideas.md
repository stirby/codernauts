...
Use workspace concepts for flavor, but avoid rewarding real resource consumption.

Good flavor:

- Templates as starter kits.
- Agents as mining helpers.
- Workspaces as player labs.
