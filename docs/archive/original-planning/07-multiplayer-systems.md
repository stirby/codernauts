...
The MVP should prove that a single programmer can build useful clients against the API. Multiplayer comes after the API, action model, resource model, and starter project is fun on its own.
