...
The primary interface is the HTTP API. The starter project should include tools, but those tools are examples and scaffolding, not the finished product.
...
codernauts sector
codernauts miners
codernauts build-miner
codernauts upgrade-miner min_starter
codernauts assign-miner min_002 site_ast_001
codernauts actions
...
First visit to the starter project:

1. Starter project shows API URL and docs path.
