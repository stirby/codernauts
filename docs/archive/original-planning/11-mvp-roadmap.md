...
The MVP is not multiplayer. It is not a polished web game. It is a central API plus a starter project that makes players productive quickly.
...
- First starter project plan drafted.
...
- Persistent miners, scanner level, and storage level.
- Activity log.
...
- Scan action.
- Miner build, upgrade, and assignment endpoints.
...
- A simple script can run status, manage miners, start a scan, and poll completion.

## Phase 4: Starter project and client kit

Features:

- Starter project with API URL and token setup.
- Starter CLI.
- Example bot.
- curl examples.
- OpenAPI file.
...
- Is the starter project useful without hiding the game?
